...
resource: https://github.com/satyaloka93/cyberpunk-vr-port/tree/upstream-0.1.3-psvr2
tags: [psvr2, steamvr, openxr, controllers, resolution]
timestamp: 2026-08-23T10:38:00+09:00
---
...
| Left grip | `squeeze/value` | Physical reload immediately; after 180 ms, scanner if reload has not claimed the wrist; scanner suppressed while mounted |
| Either grip at wheel/handlebar | `squeeze/value` | Click toggles that hand onto steering animation; second click releases |
| Right grip | `squeeze/value` | Holster/smoking/mod channel; RB only in menus |
...
- [Launcher headset presets](../../src/Overlay/LauncherDialog.cpp)
- [OpenXR runtime and device detection](../../src/Runtimes/OpenXRManager.cpp)
- [Controller input pipeline](../architecture/controller-input-pipeline.md)
- [Mounted vehicle interaction pipeline](../architecture/vehicle-interaction-pipeline.md)
